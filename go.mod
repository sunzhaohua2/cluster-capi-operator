...
require github.com/metal3-io/ip-address-manager/api v1.8.5 // indirect
...
require (
	...
	github.com/openshift/cluster-capi-operator/e2e v0.0.0-20250626044536-d3c592de4dfe
...
replace (
	...
	sigs.k8s.io/cluster-api-provider-aws/v2 => sigs.k8s.io/cluster-api-provider-aws/v2 v2.7.1-0.20250311200346-7e954867f06b
)

replace github.com/openshift/cluster-capi-operator/e2e => ./e2e
