...
// All constants are now in migration_common.go
			...
			AfterAll(func() {
				...
				if newMachine != nil {
					...
					Eventually(func() bool {
						err := cl.Get(context.Background(), key, &mapiv1.Machine{})
...
// All helper functions moved to machine_migration_helpers.go
