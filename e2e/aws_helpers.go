...
func getDefaultAWSMAPIProviderSpec(cl client.Client) (*mapiv1beta1.MachineSet, *mapiv1beta1.AWSMachineProviderConfig) {
	machineSetList := &mapiv1beta1.MachineSetList{}
	Expect(cl.List(context.Background(), machineSetList, client.InNamespace(framework.MAPINamespace))).To(Succeed())
...
func getMAPICreatedInstance(cl client.Client, awsClient *ec2.EC2, msName string) ec2.Instance {
	...
	Expect(cl.List(context.Background(), mapiMachineList, client.InNamespace(framework.MAPINamespace), client.MatchingLabels{
...
func getCAPICreatedInstance(cl client.Client, awsClient *ec2.EC2, msName string) ec2.Instance {
	...
	Expect(cl.List(context.Background(), capiMachineList, client.InNamespace(framework.CAPINamespace), client.MatchingLabels{
		machineSetOpenshiftLabelKey: msName,
	})).To(Succeed())
