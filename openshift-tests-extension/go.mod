...
require (
	...
	//github.com/openshift/cluster-capi-operator/e2e v0.0.0-00010101000000-000000000000
...
require github.com/openshift/cluster-capi-operator/e2e v0.0.0-20251105093335-4106e8bbcec1
